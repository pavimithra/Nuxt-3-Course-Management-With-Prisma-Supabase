  ...
  <header class="bg-white">
    ...
    >
      ...
      <div class="flex flex-1 items-center justify-end gap-x-6">
        <a
          href="#"
          class="flex gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 ring-1 ring-inset ring-gray-300"
          >SIGN IN
          <svg
